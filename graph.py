...
if __name__ == "__main__":
    ...
    for i in range(30): 
        ...
        #plt.hist(list_dx_cs,range=(-15,15),bins = 30)
        ...
        c = rms(list_dx_he)
        d = rms(list_dy_he)
        writer.writerow([str(file_1),a+b+c+d]) 
    f1.close   
    '''
    fig = plt.figure()
    ax1 = fig.add_subplot(2,2,1)
    ax1.hist(list_dx_cs,range=(-15,15),bins = 30)
    ...
    ax2.hist(list_dy_cs,range=(-15,15),bins = 30)
    ax2.set_title("dy_cs")
    #ax2.set_xlabel('ch along with line')


    ax3 = fig.add_subplot(2,2,3)
    ax3.hist(list_dx_he,range=(-15,15),bins = 30)
    ax3.set_title("dx_he")

    ax4 = fig.add_subplot(2,2,4)
    ax4.hist(list_dy_he,range=(-15,15),bins = 30)
    ax4.set_title("dy_he")


    fig.savefig(new_dir_path_graph + args[1] +'.png')
    '''
